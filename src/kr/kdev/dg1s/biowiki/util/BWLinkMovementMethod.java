...
public class BWLinkMovementMethod extends LinkMovementMethod {
    private static BWLinkMovementMethod mMovementMethod;

    public static BWLinkMovementMethod getInstance() {
        if (mMovementMethod == null)
            mMovementMethod = new BWLinkMovementMethod();
