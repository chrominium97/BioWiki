...
public class StatUtils {
    ...
    public static void saveSummary(String blogId, JSONObject stat) {
        try {
            ...
            FileOutputStream fos = BioWiki.getContext().openFileOutput(STAT_SUMMARY + blogId, Context.MODE_PRIVATE);
    ...
    */
    ...
    public static void deleteSummary(String blogId) {
        BioWiki.getContext().deleteFile(STAT_SUMMARY + blogId);
    }
    ...
    public static StatsSummary getSummary(String blogId) {
        ...
        try {
            FileInputStream fis = BioWiki.getContext().openFileInput(STAT_SUMMARY + blogId);
    ...
    */
    ...
    public static void saveVideoSummary(String blogId, JSONObject stat) {
        try {
            ...
            FileOutputStream fos = BioWiki.getContext().openFileOutput(STAT_VIDEO_SUMMARY + blogId, Context.MODE_PRIVATE);
    ...
    public static void deleteVideoSummary(String blogId) {
        BioWiki.getContext().deleteFile(STAT_VIDEO_SUMMARY + blogId);
    }
    ...
    public static StatsVideoSummary getVideoSummary(String blogId) {
        ...
        try {
            FileInputStream fis = BioWiki.getContext().openFileInput(STAT_VIDEO_SUMMARY + blogId);
            StringBuilder fileContent = new StringBuilder();
