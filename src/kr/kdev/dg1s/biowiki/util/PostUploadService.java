    ...
    private class UploadPostTask extends AsyncTask<Post, Boolean, Boolean> {
        ...
        protected void onPostExecute(Boolean postUploadedSuccessfully) {
            if (postUploadedSuccessfully) {
                BioWiki.postUploaded(post.getRemotePostId());
                nm.cancel(notificationID);
                BioWiki.wpDB.deleteMediaFilesForPost(post);
            } else {
        ...
        protected Boolean doInBackground(Post... posts) {
            ...
            Blog blog;
            try {
                blog = BioWiki.wpDB.instantiateBlogByLocalId(post.getLocalTableBlogId());
            } catch (Exception e) {
            ...
            for (int x = 0; x < moreCount; x++) {
                ...
                for (String tag : imageTags) {
                    ...
                    if (m.find()) {
                        ...
                        if (!imgPath.equals("")) {
                            MediaFile mf = BioWiki.wpDB.getMediaFile(imgPath, post);
        ...
        public String uploadMediaFile(MediaFile mf, Blog blog) {
            ...
            if (curImagePath.contains("video")) {
                ...
                boolean selfHosted = BioWiki.currentBlog != null && !BioWiki.currentBlog.isDotcomFlag();
