...
public class AddQuickPressShortcutActivity extends ListActivity {
    ...
    private void displayAccounts() {
        accounts = BioWiki.wpDB.getVisibleAccounts();
        ...
        dialogBuilder.setPositiveButton(R.string.add, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (TextUtils.isEmpty(quickPressShortcutName.getText())) {
                    ...
                    BioWiki.wpDB.addQuickPressShortcut(accountIDs[position], quickPressShortcutName.getText().toString());

                    if (BioWiki.currentBlog == null) {
                        try {
                            BioWiki.currentBlog = BioWiki.wpDB.instantiateBlogByLocalId(accountIDs[position]);
                            BioWiki.wpDB.updateLastBlogId(accountIDs[position]);
                        } catch (Exception e) {
                        }
                    }
    ...
    protected class HomeListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            blavatar.setImageUrl(blavatars[position], BioWiki.imageLoader);
