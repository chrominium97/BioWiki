...
public class FollowRow extends LinearLayout {
    ...
    void setAction(JSONObject actionJSON) {
        ...
        try {
            ...
            AppLog.e(AppLog.T.NOTIFS, String.format("Could not set action from %s", actionJSON), e);
            followButton.setVisibility(GONE);
            setSiteUrl(null);
            setClickable(false);
            mParams = null;
    ...
    void setFollowing(boolean following) {
        if (hasParams()) {
            try {
                ...
                AppLog.e(AppLog.T.NOTIFS, String.format("Could not set following %b", following), e);
            }
        }
