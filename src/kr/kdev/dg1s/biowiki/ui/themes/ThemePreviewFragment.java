...
public class ThemePreviewFragment extends SherlockFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mWebView.setWebChromeClient(new BWWebChromeClient(getActivity(), (ProgressBar) view.findViewById(
                R.id.progress_bar)));
    ...
    protected void loadAuthenticatedUrl(String url) {
        try {
            ...
            mWebView.postUrl(BioWiki.getLoginUrl(mBlog), postData.getBytes());
