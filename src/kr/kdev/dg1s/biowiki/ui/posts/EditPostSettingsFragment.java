...
public class EditPostSettingsFragment extends SherlockFragment implements View.OnClickListener {
            ...
            postFormatSpinner.setOnTouchListener(
                    new View.OnTouchListener() {
                        ...
                        public boolean onTouch(View view, MotionEvent motionEvent) {
                            BWMobileStatsUtil.flagProperty(mActivity.getStatEventEditorClosed(), BWMobileStatsUtil.StatsPropertyPostDetailSettingsClickedPostFormat);
                            return false;
                        }
                    }
            );
        ...
        if (post != null) {
            ...
            mStatusSpinner.setOnTouchListener(
                    new View.OnTouchListener() {
                        @Override
                        public boolean onTouch(View view, MotionEvent motionEvent) {
                            BWMobileStatsUtil.flagProperty(mActivity.getStatEventEditorClosed(), BWMobileStatsUtil.StatsPropertyPostDetailSettingsClickedStatus);
                            return false;
                        }
                    }
            );
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.pubDateButton) {
            BWMobileStatsUtil.flagProperty(mActivity.getStatEventEditorClosed(), BWMobileStatsUtil.StatsPropertyPostDetailSettingsClickedScheduleFor);
            showPostDateSelectionDialog();
        } else if (id == R.id.selectCategories) {
            Bundle bundle = new Bundle();
            bundle.putInt("id", BioWiki.getCurrentBlog().getLocalTableBlogId());
            ...
            BWMobileStatsUtil.flagProperty(mActivity.getStatEventEditorClosed(), BWMobileStatsUtil.StatsPropertyPostDetailClickedShowCategories);
            ...
            if (latitude != 0.0) {
                BWMobileStatsUtil.flagProperty(mActivity.getStatEventEditorClosed(), BWMobileStatsUtil.StatsPropertyPostDetailSettingsClickedAddLocation);
            ...
            BWMobileStatsUtil.flagProperty(mActivity.getStatEventEditorClosed(), BWMobileStatsUtil.StatsPropertyPostDetailSettingsClickedUpdateLocation);
            getLocation();
        } else if (id == R.id.removeLocation) {
            BWMobileStatsUtil.flagProperty(mActivity.getStatEventEditorClosed(), BWMobileStatsUtil.StatsPropertyPostDetailSettingsClickedRemoveLocation);
            removeLocation();
        }
    }
    ...
    public void savePostSettings() {
        ...
        } else if (BioWiki.getCurrentBlog().isLocation() && !mActivity.getPost().isPage()) {
            latitude = mCurrentLocation.getLatitude();
    ...
    private void initLocation(ViewGroup rootView) {
        ...
        if (hasLocationProvider && BioWiki.getCurrentBlog().isLocation() && !mActivity.getPost().isPage()) {
