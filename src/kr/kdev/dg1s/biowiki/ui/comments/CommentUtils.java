...
import kr.kdev.dg1s.biowiki.util.BWImageGetter;
import kr.kdev.dg1s.biowiki.util.Emoticons;
...
public class CommentUtils {
    ...
    public static void displayHtmlComment(TextView textView, String content, int maxImageSize) {
        ...
        if (maxImageSize > 0 && content.contains("<img")) {
            html = Html.fromHtml(content, new BWImageGetter(textView, maxImageSize), null);
        } else {
