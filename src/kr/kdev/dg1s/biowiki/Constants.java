...
public class Constants {
    ...
    public static class PlantsAttributes {
        ...
        public static class Leaves {
            ...
            public static class ORDER_AND_STH_ELSE { //잎차례, 겹잎
                ...
                public static String[] SIMPLE_OPPOSITE = {
                ...
                public static String[] FASCICULATE = {
            ...
            public static String[] viternateLeaf = {"수레나물(사위질빵)", "으아리"};
            ...
            public static String[] oddBipinnate = {
                    ...
                    "두릅나무", "모감주나무"};
            public static String[] evenBipinnate = {"자귀나무"};

            //엽형
            //침형, 선형, 피침형, 도피침형, 심장형, 신장형, 원형, 타원형, 장타원형,
            public static String[] acicular = {
            ...
            public static String[] oblancolate = {
                    ...
                    "꼬리고사리", "돌나물", "물망초"};
            public static String[] cordate = {
                    "어저귀", "봄맞이꽃", "새모래덩굴", "쥐방울", "박주가리(새박덩굴)",
                    "꼭두선이", "참취", "새박덩굴", "수염마름", "물옥잠",
            };
            public static String[] reniform = {"며느리밑씻개(사광이아재비)", "새모래덩굴"};
            public static String[] orbicular = {
            ...
            public static String[] hastate = {"애기메꽃", "나도미꾸리"};
            public static String[] sagittate = {
            ...
            public static String[] acute = {
                    ...
                    "돌나물", "산달래(족지)", "금낭화"};
            public static String[] mucronate = {
            ...
            public static String[] parted = {
                    ...
                    "넉줄고사리"};
            public static String[] pinnatifid = {
    ...
    public static String[] cruciform = {
            ...
            "장대나물", "좀개갓냉이"};
    public static String[] coronate = {"까마중(가마중)", "개머루", "까마귀머루"};
    public static String[] campanulate = {"박주가리(새박덩굴)", "새삼"};
    ...
    public static String[] papillionaceous = {
            ...
            "자운영"};
    public static String[] saccate = {"금낭화"};
    public static String[] salver = {};
    public static String[] urceolate = {"고욤나무"};
   ...
   //수상화서, 총상화서, 산방화서, 산형화서, 원추화서, 선형화서, 취산화서, 두상화서, 육수화서, 미상화서, 배상화서
    ...
    public static String[] spedix = {"반하(꿩의무릇)", "창포", "애기부들"};
    ...
    // (한글이름으로, 뒤의 글자'열매' 뺐음)
    public static String[] aggregate = {"뱀딸기", "산뽕나무", "산딸기나무(나무딸기)", "멍석딸기"};
    ...
    public static String[] pome = {"산사나무(아가외나무)"};
    public static String[] pyxis = {"뚜껑덩굴"};
    ...
    public static String[] samara = {"당느릅니무", "참느릅나무", "개죽나무(가중나무)", "신나무"};
